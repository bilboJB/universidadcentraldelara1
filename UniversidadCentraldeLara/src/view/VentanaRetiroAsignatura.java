...
public class VentanaRetiroAsignatura extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaRetiroAsignatura frame = new VentanaRetiroAsignatura();
	 ...
	 * Create the frame.
	 */
	public VentanaRetiroAsignatura() {
		...
		retiroAsignatura.setIcon(new ImageIcon(VentanaRetiroAsignatura.class.getResource("/iconos/listado de estudiante por semestre.png")));
		...
		btnBuscarAsignatura.setIcon(new ImageIcon(VentanaRetiroAsignatura.class.getResource("/iconos/iconsLupa30.png")));
		...
		btnGenerarListado.setIcon(new ImageIcon(VentanaRetiroAsignatura.class.getResource("/iconos/iconsLista50.png")));
		...
		btnVolver.setIcon(new ImageIcon(VentanaRetiroAsignatura.class.getResource("/iconos/iconsVolver30.png")));
		...
		btnMinimizar.setIcon(new ImageIcon(VentanaRetiroAsignatura.class.getResource("/iconos/btn-minimizar.png")));
		btnMinimizar.setBackground(Color.BLACK);
		btnMinimizar.setBounds(902, 11, 44, 29);
		panel.add(btnMinimizar);
		
		JButton btnSalir = new JButton("");
		btnSalir.setIcon(new ImageIcon(VentanaRetiroAsignatura.class.getResource("/iconos/btn-cerrar.png")));
		btnSalir.setBackground(Color.BLACK);
		btnSalir.setBounds(948, 11, 44, 29);
		panel.add(btnSalir);
		
		JLabel fondo = new JLabel("");
		fondo.setIcon(new ImageIcon(VentanaRetiroAsignatura.class.getResource("/iconos/fondoMenu.jpg")));
