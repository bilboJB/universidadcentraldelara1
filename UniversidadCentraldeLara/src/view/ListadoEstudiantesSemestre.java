...
public class ListadoEstudiantesSemestre extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListadoEstudiantesSemestre frame = new ListadoEstudiantesSemestre();
	 ...
	 * Create the frame.
	 */
	public ListadoEstudiantesSemestre() {
		...
		estudianteXSemestre.setIcon(new ImageIcon(ListadoEstudiantesSemestre.class.getResource("/iconos/listado de estudiante por semestre.png")));
		...
		btnBuscarSemestre.setIcon(new ImageIcon(ListadoEstudiantesSemestre.class.getResource("/iconos/iconsLupa30.png")));
		...
		btnGenerarListado.setIcon(new ImageIcon(ListadoEstudiantesSemestre.class.getResource("/iconos/iconsLista50.png")));
		...
		btnVolver.setIcon(new ImageIcon(ListadoEstudiantesSemestre.class.getResource("/iconos/iconsVolver30.png")));
		...
		btnMinimizar.setIcon(new ImageIcon(ListadoEstudiantesSemestre.class.getResource("/iconos/btn-minimizar.png")));
		btnMinimizar.setBackground(Color.BLACK);
		btnMinimizar.setBounds(903, 11, 44, 29);
		panel.add(btnMinimizar);
		
		JButton btnSalir = new JButton("");
		btnSalir.setIcon(new ImageIcon(ListadoEstudiantesSemestre.class.getResource("/iconos/btn-cerrar.png")));
		btnSalir.setBackground(Color.BLACK);
		btnSalir.setBounds(949, 11, 44, 29);
		panel.add(btnSalir);
		
		JLabel fondo = new JLabel("");
		fondo.setIcon(new ImageIcon(ListadoEstudiantesSemestre.class.getResource("/iconos/fondoMenu.jpg")));
